  ...
  return (
   <>
        <div name="contact" className='py-10 w-full h-full  bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
            <div className='flex flex-col p-4 pt-12 justify-center max-w-screen-lg mx-auto h-full'>
                <div className='pb-8'>
                ...
                <div className='flex justify-center'>
                    <form action="https://getform.io/f/lakmkqna" method='POST' className='flex flex-col w-full md:w-1/2 '>
                        ...
                        <textarea name="message" id="" rows="10" className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none resize-none'></textarea>
